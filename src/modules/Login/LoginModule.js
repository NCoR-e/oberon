...
export const rootElement = document.querySelector('[data-js-container]');
export const buttonsElements = Array.from(rootElement.querySelectorAll('[data-js-button]'));
export const INITIAL_STATE = { section: 'login', currentForm: 'auth', switch: 'auth' };
export let activeState = {}

export function updateUI(elements, attrName, targetValue, requiredForm = null, isButton = false) {
...
// V -View
export function handleClick(isAction) {
...
// VM - ViewModel
export function modelController(data, updated) {
    let pageConfig = {
        login: {
            reg: {
...
export const renderUI = (uiElements) => (inputData) => {
